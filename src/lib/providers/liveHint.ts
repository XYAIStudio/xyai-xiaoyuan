import { LIVE_DEFAULTS } from "./endpoints";

export const PREFERRED_LIVE_ID = "freeos";
export const PREFERRED_LIVE_PORT = LIVE_DEFAULTS.freeos.port;
export const PREFERRED_LIVE_URL = LIVE_DEFAULTS.freeos.url;
...
/** Prefer FreeOS :8088; :3000 closed is expected and skippable. */
export function recommendLiveHint(
  live: LiveProbeRow[],
  mock: Array<{ ok?: boolean }> = [],
): string {
